...
if __name__ == '__main__':
    ...
    # input_file = "cn_input_reduced_corr_rm.yaml"
    # sequence(input_file)
    
    
    input_file = "fp_c_input_reduced_corr_rm2.yaml"
    sequence(input_file)
    
    
    # input_file = "mp_c_input_reduced_corr_rm.yaml"
    # sequence(input_file)
    
    
    # input_file = "MW_input_reduced_corr_rm.yaml"
    # sequence(input_file)
    
    
    # input_file = "HC_input_reduced_corr_rm.yaml"
    # sequence(input_file)